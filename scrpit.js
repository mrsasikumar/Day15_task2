...
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="ChickenBiriyani"  id="ChickenBiriyani"  name="option"/>
  <label class="form-check-label" for="ChickenBiriyani"> Chicken Biriyani </label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="MuttonBiriyani"  id="MuttonBiriyani"  name="option" />
  <label class="form-check-label" for="MuttonBiriyani"> Mutton Biriyani </label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Chicken Fry"  id="Chicken Fry"  name="option" />
  <label class="form-check-label" for="Chicken Fry"> Chicken Fry </label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Chicken Noodles"  id="Chicken Noodles"  name="option" />
  <label class="form-check-label" for="Chicken Noodles"> Chicken Noodles </label>
</div>
<div class="form-check">
    <input  class="form-check-input"  type="checkbox"  value="Chicken Rice"  id="Chicken Rice"  name="option" />
    <label class="form-check-label" for="Chicken Rice"> Chicken Rice </label>
</div>`;
form1.append(f_div6);
